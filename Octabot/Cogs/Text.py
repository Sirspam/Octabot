...
class Text(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="shuffleinfo",value="> Post the name of the song currently playing in the shuffle queue")
        embed.add_field(name="shuffleclear",value="> Clears all songs in the shuffle queue")
    ...
    async def embedt(self, ctx): #I kept this here just because I find it funny
        ...
        await ctx.send(embed=embed, delete_after=8) #it's funny because 8 is the funny octagon sides and angles number
