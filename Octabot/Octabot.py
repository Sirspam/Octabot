...
import discord, logging, os, os.path, asyncio
...
async def main():
    ...
    async with client:
        ...
        await client.start(Token) #I've made it so the token is read from an external file. This is just so I don't have to edit out the token whenever uploading to the github registory
